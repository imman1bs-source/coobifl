/**
 * Replace Amazon products with the 16 real ones that have images
 */
...
async function replaceAmazonProducts() {
  try {
    ...
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/amazon_product_hub');
